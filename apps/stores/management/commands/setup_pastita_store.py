...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if not StoreDeliveryZone.objects.filter(store=store).exists():
            default_zones = [
                {'name': 'Centro', 'distance_band': '0_2', 'delivery_fee': Decimal('5.00'), 'color': '#4CAF50', 'sort_order': 1},
                {'name': 'Próximo', 'distance_band': '2_5', 'delivery_fee': Decimal('8.00'), 'color': '#8BC34A', 'sort_order': 2},
                {'name': 'Médio', 'distance_band': '5_8', 'delivery_fee': Decimal('12.00'), 'color': '#FFC107', 'sort_order': 3},
                {'name': 'Distante', 'distance_band': '8_12', 'delivery_fee': Decimal('15.00'), 'color': '#FF9800', 'sort_order': 4},
                {'name': 'Muito Distante', 'distance_band': '12_15', 'delivery_fee': Decimal('20.00'), 'color': '#FF5722', 'sort_order': 5},
            ]
