...
class CustomersViewSet(viewsets.ViewSet):
    ...
    def debug(self, request):
        ...
        # Superuser vê qualquer loja; os demais só as próprias. is_staff
        # (IsAdminUser) não atravessa tenant.
        if not (request.user.is_superuser or _user_can_use_store(request.user, store_id)):
