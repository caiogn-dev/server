...
• Para fechar um COMBO use adicionar_combo_ao_carrinho(nome, sabores) — nunca adicione os itens do combo um a um, porque isso cobra o preço avulso em vez do preço do combo
