...
# ConversationHandover was removed from this module.
# Canonical model lives in apps.handover.models.ConversationHandover.
# Access via conversation.handover (OneToOne, related_name='handover').
