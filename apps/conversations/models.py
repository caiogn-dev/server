...
# DEPRECATED: Use apps.handover.models.ConversationHandover instead
# This model is kept for backward compatibility but will be removed in a future version
# The canonical handover implementation is in apps.handover
# Migration path: Data should be migrated to apps.handover_conversationhandover table
