...
class AutomationConsumer(FirstMessageAuthMixin, AsyncJsonWebsocketConsumer):
    ...
    async def handle_message(self, content):
        ...
        if message_type == 'ping':
            ...
            if company_id:
                ...
                await self.send_json({'type': 'subscribed', 'company_id': company_id})
            ...
            if company_id:
                ...
                await self.send_json({'type': 'unsubscribed', 'company_id': company_id})
