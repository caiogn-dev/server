...
class WhatsAppAuthService:
    ...
    def send_auth_code(
        ...
        logger.debug(f"[WHATSAPP AUTH] Template configs: {len(template_configs)} templates")
        ...
        for i, template_data in enumerate(template_configs):
            ...
            logger.debug(f"[WHATSAPP AUTH] Components: {len(template_data.get('components', []))} component(s)")
